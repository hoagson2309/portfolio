...
window.PORTFOLIO_PROJECTS = [
  ...
  },
  {
    ...
    description: "AutoMaze is a university group project where a team of four built a fully autonomous robot car in C++ on a Raspberry Pi Pico. The robot's mission: enter an unknown maze, find a gold-coin treasure using IR sensors, and return to the entrance via the optimal route -- all without hitting walls and within a 400x250x200 mm chassis. The project ran over 8 agile sprints using Jira and GitHub.",
  ...
  {
    id: "tinyml-snake",
    title: "TinyML Air Gesture Snake Game",
    client: "Personal Project",
    subtitle: "A snake game controlled by hand gestures using TinyML on an Arduino Nano 33 BLE.",
    category: "embedded",
    year: "2026",
    featured: false,
    mediaType: "image",
    media: "assets/images/project-6.png",
    link: "project.html?id=tinyml-snake",

    role: "TinyML / Embedded Developer",
    tools: ["C++", "Python", "Arduino Nano 33 BLE", "Edge Impulse", "Pygame", "IMU (BMI270)", "Serial"],
